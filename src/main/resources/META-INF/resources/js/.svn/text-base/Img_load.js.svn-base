...
//    	toastr["success"]("success", "图片上传成功");
        ...
        try{
            ...
            $("#dialog-tiaozhuan .modal-body").html("<span style='color:green'><b>上传成功！</b></span>");
...
//        toastr["error"]("error", "Eroor: " + e)
            try{
                ...
                switch (e){
                    case 'Q_EXCEED_NUM_LIMIT':
                        $("#dialog-tiaozhuan .modal-body").html("<span style='color:red'><b>上传失败！超出图片上传数量</b></span>");
                        break
                    case 'Q_EXCEED_SIZE_LIMIT':
                        $("#dialog-tiaozhuan .modal-body").html("<span style='color:red'><b>上传失败！超出图片总大小</b></span>");
                        break
                    case 'Q_TYPE_DENIED':
                        $("#dialog-tiaozhuan .modal-body").html("<span style='color:red'><b>上传失败！图片格式错误</b></span>");
                        break
                    default:
                        $("#dialog-tiaozhuan .modal-body").html("<span style='color:red'><b>上传失败！</b></span>");
                }
                // $("#dialog-tiaozhuan-content").html("<span style='color:red'><b>上传失败！图片重复</b></span>");
                $("#dialog-tiaozhuan").modal("show");
            }
...
//        toastr["warning"]("warning", "todo")
                try{
                    ...
                    $("#dialog-tiaozhuan .modal-body").html("<span style='color:red'><b>上传失败！" + e + "</b></span>");
                    $("#dialog-tiaozhuan").modal("show");
                }
