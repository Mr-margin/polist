        ...
        $.each(this.columns, function(i, column) {
            ...
            if (column.editable.hasOwnProperty('source')) {
            	column.editable.source = function () {
                    ...
                    var row = $('#metTable'+column.editable.metTable).bootstrapTable('getData')[index];
//                    console.log(column);
...
//                    console.log(requestData);
            ...
            if (column.editable.hasOwnProperty('validate')) {
            	...
            	}else if(column.editable.validate == "validate_1_2"){
            		column.editable.validate = validate_1_2;
            	}else if(column.editable.validate == "validate_1_3"){
            		column.editable.validate = validate_1_3;
