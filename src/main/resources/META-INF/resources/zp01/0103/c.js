...
//			"<td><a id=\"dcmeantrans\"></a></td>" +
//			"<td><a id=\"dctransamount\"></a></td>" +
//			"<td><a><img title=\"删除设备\" onclick=\"moduan_delete(this,'yunzai_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
//			"<td><a id=\"dustcontrol\"></a></td>" +
//			"<td><a id=\"otherdustcontrol\"></a></td>" +
//			"<td><a><img title=\"删除设备\" onclick=\"moduan_delete(this,'cuoshi_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_sj_rl(title,td){
	...
	var kongzhi = "<tr id=\"rl"+index+"\" class=\"zhong\">" +
			...
			"<td><a id=\""+td+"11\"></a></td>" +
			"<td><a id=\""+td+"12\"></a></td>" +
			"<td><a><img title=\"删除设备\" onclick=\"moduan_delete(this,'"+title+"_rl_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
var bianhao = {"表p02_锅炉信息表":"GL","表p07_有机液体储罐信息表":"CG","表p1011_机组信息表":"JZ","表p05_炼焦工序信息表":"LJ","表p2011_烧结工序信息表":"SJ","表p2014_球团工序信息表":"QT","表p2012_炼铁工序信息表":"LT",
		"表p2013_炼钢工序信息表":"LG","表p2015_轧钢信息表":"ZG","表p2016_石灰石信息表":"YL","表p06_堆场信息表":"DC","表p2021_熟料生产信息表":"YL","表p2022_水泥生产信息表":"FM","表p2031_玻璃生产信息表":"YL","表p08_有机液体装载信息表":"ZZ",
