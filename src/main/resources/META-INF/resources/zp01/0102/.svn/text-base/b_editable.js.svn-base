...
function validate_4(v){
	...
	var age = parseInt(v);
  var date = "";
  if(typeof window.sessionStorage.getItem("year") != "undefined")  date = window.sessionStorage.getItem("year");
...
var columns_zbfdz = [{//自备发电组
    ...
    source:function () {
    	var result = [];
    	$("#add_pfk_table tr").each(function(i,g){
...
var columns_yaolu_cp =[{//表comp06_窑炉信息表-产品
    title:"窑炉编号",
    type:"select",
    field:"equipId",
    validate:validate_1,
    source:function () {
    	var result = [];
    	$("#add_yaolu_table1 tr").each(function(i,g){
...
var columns_yaolu_yl =[{//表comp06_窑炉信息表-原料
    title:"窑炉编号",
    type:"checklist",
    field:"equipId",
    source:function () {
    ...
    source:function () {
    	var result = [];
    	$("#add_yaolu_cp_table tr").each(function(i,g){
...
var columns_yaolu_rl =[{//表comp06_窑炉信息表-燃料
    title:"窑炉编号",
    type:"checklist",
    field:"equipId",
    source:function () {
