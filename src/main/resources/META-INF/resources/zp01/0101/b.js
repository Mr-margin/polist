...
$(function (){
	...
	$("#sy").click(function(){
		if ( stype != "look" ) {
			if(edit_show()){
				window.location.href="../a.html?sole="+seesion_sole;
			}else{
...
function add_sccp(){
	...
	var kongzhi = "<tr id=\"sccp"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_sccp_table1')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_sccp_cp(){
	...
	var kongzhi = "<tr id=\"sccp_cp"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_sccp_cp_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_sccp_yl(){
	...
	var kongzhi = "<tr id=\"sccp_yl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_sccp_yl_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_sccp_rl(){
	...
	var kongzhi = "<tr id=\"sccp_rl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_sccp_rl_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_sccp_zl(){
	...
	var kongzhi = "<tr id=\"sccp_zl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_sccp_zl_table')\" src=\"../images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function moduan_delete(obj, table){
	if ( stype == "update" ) {
		if($(".editable-disabled").length == 2){
				...
				$("#add_sccp_cp_table tr").each(function(){
					if(typeof $(this).find("#equipId").editable("getValue").equipId != "undefined"){
						if($(this).find("#equipId").editable("getValue").equipId == $(obj).parent().parent().parent().find("#equipId")[0].textContent){
							...
							$(this).remove();
							$("#add_sccp_yl_table tr").each(function(){
							...
							$("#add_sccp_rl_table tr").each(function(){
								if(typeof $(this).find("#v1").editable("getValue").v1 != "undefined"){
									if($(this).find("#v1").editable("getValue").v1 == str ){
										$(this).remove();
									}
			...
			} else if ( table == "add_sccp_cp_table" ) {
				$(obj).parent().parent().parent().remove();
				$("#add_sccp_yl_table tr").each(function(){
					if(typeof $(this).find("#v1").editable("getValue").v1 != "undefined"){
...
//$(obj).parent().parent().parent().find("#equipId")[0].textContent
