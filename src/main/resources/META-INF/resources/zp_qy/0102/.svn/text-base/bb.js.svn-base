...
function add_rlxx(){//添加燃料信息表 
		...
		var kongzhi = "<tr id=\"rlxx"+index+"\" class=\"zhong\"  height=\"35px\">" +
				...
				"<td><a id=\"fuel12\"></a></td>" +
				"<td style='display:none;'><a id=\"status\"></a></td>" +
				"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_rlxx_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_cpxx (){//添加产品信息表  
	...
	var kongzhi = "<tr id=\"cpxx"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_cpxx_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_pfk(){//添加排放口信息表  
	...
	var kongzhi = "<tr id=\"pfk"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_pfk_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_zbfdz (){//添加自备发电机组信息表 
	...
	var kongzhi = "<tr id=\"zbfdz"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"pfkids\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_zbfdz_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_zbfdz_md(){//添加自备发电机组信息表——末端控制措施信息表 
		...
		var kongzhi = "<tr id=\"zbfdz_md"+index+"\" class=\"zhong\"  height=\"35px\">" +
				...
				"<td style='display:none;'><a id=\"status\"></a></td>" +
				"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_zbfdz_md_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_guolu_md () {//添加锅炉信息表——末端控制措施信息表 
	...
	var kongzhi = "<tr id=\"guolu_md"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"equipIdpm\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_guolu_md_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yaolu_md(){//添加窑炉信息表——末端控制措施信息表 
	...
	var kongzhi = "<tr id=\"yaolu_md"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"equipIdpm\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yaolu_md_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yfl (){//添加原辅料及产品信息表
	...
	var kongzhi = "<tr id=\"yfl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"pfkids\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yfl_table1')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yfl_md(){//添加原辅料及产品信息表——末端控制措施信息表 
	...
	var kongzhi = "<tr id=\"yfl_md"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"equipIdpm\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yfl_md_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_rjsy(){//添加溶剂使用信息表 
	...
	var kongzhi = "<tr id=\"rjsy"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"pfkids\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_rjsy_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yaolu_yl(){//窑炉数-原料
	var index = (new Date()).valueOf();
	 var kongzhi = "<tr id=\"yaolu_yl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yaolu_yl_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yaolu_rl(){//窑炉数-燃料
	var index = (new Date()).valueOf();
	 var kongzhi = "<tr id=\"yaolu_rl"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yaolu_rl_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
//			"<td><a id=\"equipId\"></a></td>" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yfl_yl_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
//			"<td><a id=\"equipId\"></a></td>" +
			...
			"<td><a id=\"v1\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yfl_fl_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
...
function add_yfl_cp(){//添加辅料信息
	...
	var kongzhi = "<tr id=\"yfl_cp"+index+"\" class=\"zhong\"  height=\"35px\">" +
			...
			"<td><a id=\"equipId\"></a></td>" +
			"<td style='display:none;'><a id=\"status\"></a></td>" +
			"<td><a><img title=\"删除\" onclick=\"moduan_delete(this,'add_yfl_cp_table')\" src=\"../../zp01/images/delete.png\" style=\"width:16px;height:16px;\"></a></td></tr>";
