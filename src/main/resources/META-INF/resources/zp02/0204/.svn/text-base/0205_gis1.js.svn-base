...
var gisUserId =[];
function  point() {
	var data = ajax_async_t(BackstageIP+"taskDataFillChild/selectLonAndLatCom",{region:dataBase.Login_map.REGION,taskId:$("#select_1").val()},"JSON","1","POST");
