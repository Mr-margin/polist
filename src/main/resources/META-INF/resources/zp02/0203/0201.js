...
//			if( datas.data!="" && datas.data!= null && datas.data != undefined ) 
		}else{
...
//	console.log(sj_data);
//	if(sj_data != "" && sj_data != undefined && sj_data != null ) {
//		if (sj_data.length > 0 ) {
//			$("#selcity").attr("checked",true);
//		}
//	}
					...
					if(hb_had[x].sourceId == hb_data[i].value[y].id&&hb_had[x].userCount>0){
						...
						if(i<10){
							...
							/*if($("#pf1").is(':checked')){
								...
								$("#hb_tbody input[name='hb_checkbox"+i+"'][value='"+hb_data[i].name+"']").attr("disabled",true);
								$("#hb_tbody input[name='hb_add_class"+i+"'][value='"+hb_data[i].value[y].id+"']").attr("disabled",true);
							}*/
