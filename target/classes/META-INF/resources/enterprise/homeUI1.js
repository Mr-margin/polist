...
$(function() {
	...
	var banner = "" +
			"<DIV id='users'>" +
			"<A id='out_login' onClick='' href='#'>退出</A>" +
			"<A id='update_password' onClick='' href='#'>修改密码</A>" +
			"<A style='cursor: default;' href='#'>";
			if ( dataBase.Message_map != "" && dataBase.Message_map != null && dataBase.Message_map != undefined) {
				banner+="<FONT color='red'>"+dataBase.Message_map.NAME+"</FONT></A>" ;
			} else {
				banner+="<FONT color='red'></FONT></A>" ;
			}
			"</DIV>";
	...
	var foouft = "<DIV class='contacts'>" +
		...
		"<DIV class='item' style='height: 72px; background-image: url(../ui/images/contact_tel.png);'>" +
		"为使您的咨询问题及时得到答复，请您务必<BR> 拨打以下技术支持电话，请勿拨打其它电话：<BR>010-84949045" +
		"</DIV>" +
		"<DIV class='item' style='height: 72px; background-image: url(../ui/images/contact_email.png);'>" +
		"如电话繁忙请通过以下邮箱进行咨询： <BR>" +
		"<A href='mailto:program@most.cn'></A>&nbsp;&nbsp;&nbsp;" +
		"</DIV>" +
		"<DIV class='item' style='height: 72px; background-image: url(../ui/images/contact_fax.png);'>" +
		"传真请发送至：010-84949045" +
		"</DIV></DIV>" +
...
function show_copyright() {
	...
	if(copyright[copy_region] != "" && copyright[copy_region] != null && copyright[copy_region] != undefined){
		...
		var foot = "<DIV class='contacts'>" +
					...
					"<DIV class='item' style='height: 72px; background-image: url(../ui/images/contact_tel.png);'>" +
					"为使您的咨询问题及时得到答复，请您务必<BR> 拨打以下技术支持电话，请勿拨打其它电话：<BR>"+str.copy_tel+
					"</DIV>" +
					"<DIV class='item' style='height: 72px; background-image: url(../ui/images/contact_email.png);'>" +
					"如电话繁忙请通过以下邮箱进行咨询：<br>" +
					"<a href='mailto:program@most.cn'></a>" +
