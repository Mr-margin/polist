 ...
 */
var select_smallIndex = ["表p2011_烧结工序信息表","表es2011_钢铁行业信息表","表es4041_农药使用信息表","表s3011_保有量信息表","表ep2011_烧结工序信息表","表s2011_钢铁行业信息表","表es3011_保有量信息表","表s4041_农药使用信息表",
...
//                    console.log(column);
//                    console.log(row);
                    if ( row.bigIndex == "附件s201_钢铁行业调查表" || row.bigIndex == "附件s202_水泥行业调查表" ) {
                    	if(column.title == "工序类别(必填)") requestData.sheetName = "list-stageequipproducttype";
                    }
