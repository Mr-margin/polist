...
//				window.location.href="a.html";
	...
	$("#gkgs").click(function (){
		if ( stype =="look" ) {
			window.location.replace("/polist/zp_qy/0103/b.html?taskId="+taskId+"&status="+statusCode+"&userId="+userId+"&userName="+userName+"&year="+year);
		} else {
			if( look_or_up == 1 ) {
				window.location.replace("/polist/zp_qy/0103/b.html?taskId="+taskId+"&status="+statusCode+"&userId="+userId+"&userName="+userName+"&year="+year);
			} else {
