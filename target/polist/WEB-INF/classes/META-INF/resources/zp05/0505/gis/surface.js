...
//	var data = ajax_async_t(BackstageIP+url,{bookId:$("#bookId").val(),species:$('input[name="wz"]:checked').val(),key:str,region:region_code,scc2:chosse_hy,custom:JSON.stringify(zdysj)},"json");
	console.log(data)
...
//    var symbol = new dong.PictureMarkerSymbol("bar.png",20*3,30*3);
//    symbol.setOffset(-10*3,18*3);
//    var graphics = app.chart.graphics;
